# -*- coding: utf-8 -*-
"""Kopia av Fast Fuzzy Matching public.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qeWxq2xFhTFJFBEFlWvNRz-ljRBo5aKU
...
names =  pd.read_csv('messy org names.csv',sep=';')
...
# print('All 3-grams in "Depörtment":')
# print(ngrams('Depörtment'))

print(ngrams('RESTAURANG GREENS'))
print(ngrams('Rivjarn'))
...
# t = time.time()-t1
# print("SELFTIMED:", t)
# print("Estimated hours to complete for full dataset:", (t*len(org_names)))
...
# matches_df = get_matches_df(matches, org_names, top=20)
# #matches_df = matches_df[matches_df['similairity'] < 0.99999] # Remove all exact matches
# #matches_df.sample(20)

# matches_df.sort_values(['similairity'], ascending=False)
...
clean_org_names = pd.read_csv('Gov Orgs ONS.csv', sep=';')
org_name_clean = clean_org_names['Institutions'].unique()
print("#########################3")
#for name in org_name_clean:
#    print(name)
...
for i,j in enumerate(indices):
  temp = [distances[i][0], org_name_clean[j],unique_org[i]]
  #  print(i)
  #  print(j)
  #  print(clean_org_names.values[j][0][0])
  #  print(unique_org[i])

  matches.append(temp)
#print(clean_org_names)
#print(indices)

#for i,j in enumerate(indices):
#    print("{} :::: {} ".format (clean_org_names.values[j][0][0],unique_org[i]))
